...
var buildTreeFromObject = function buildTreeFromObject() {
  var sampleData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  ...
  var myReturn = [{
    ...
    "children": [{
      ...
      "children": [{
        "name": "prefixName.b.c[0]",
        "displayName": "[0]",
        "type": "number",
        "defaultValue": 0,
        "children": []
      }, {
        "name": "prefixName.b.c[1]",
        "displayName": "[1]",
        "type": "number",
        "defaultValue": 1,
        "children": []
      }, {
        "name": "prefixName.b.c[2]",
        "displayName": "[2]",
        "type": "number",
        "defaultValue": 2,
        "children": []
      }, {
        "name": "prefixName.b.c[3]",
        "displayName": "[3]",
        "type": "number",
        "defaultValue": 3,
        "children": []
      }, {
        "name": "prefixName.b.c[4]",
        "displayName": "[4]",
        "type": "number",
        "defaultValue": 4,
        "children": []
